...
# final_particle_type = np.array(final_particle_type)
# final_position = np.asarray(final_position)
print(len(final_particle_type))
# test = final_position[1]
# print(final_particle_type[1])
# print(final_particle_type[1].tobytes())
# print(test.shape)
# print(p.shape)
...
for i in range(len(final_particle_type)):
  # print(final_particle_type[i].tobytes(),final_position[i].tobytes())
  example = serialize_example(i,final_particle_type[i].tobytes(),final_position[i])
  # parsed_feature = parse_serialized_simulation_example(i,meta)
  # parsed_feature = tf.train.SequenceExample.FromString(serialized)
